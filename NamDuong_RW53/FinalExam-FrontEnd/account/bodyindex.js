...
function Create() {
  ...
  var item_FirstName = document.getElementById("FirstName").value;
  var item_LastName = document.getElementById("LastName").value;
  var item_inputRole = document.getElementById("inputRole").value;
  var item_inputDepartment = document.getElementById("inputDepartment").value;
  console.log(item_username, item_Password);
}
// get listDepartment
